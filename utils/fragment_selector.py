...
Allows switching between different fragment lists (short, medium, or long)
"""

from typing import List, Dict
from models import shortList_frag, mediumList_frag, longList_frag
...
class FragmentSelector:
    ...
    LIST_OPTIONS = {
        ...
        'medium': mediumList_frag.fragments,
    ...
    def get_fragments(cls, list_name: str = 'short') -> List[Dict]:
        ...
        Args:
            list_name: Name of list to use ('short', 'medium', or 'long')
        Returns:
